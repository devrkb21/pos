...
Route::get('/install/check', 'Install\InstallController@forceCheck')->name('install.forceCheck');
Route::get('/install/xupdate', 'Install\InstallController@forceUpdate')->name('install.forceUpdate');