...
@section('content')
    <div class="col-md-6 col-sm-5 hidden-xs eq-height-col login-form-left">
    ...
    <div class="login-form col-md-6 col-sm-7 col-xs-12 right-col-content">
