...
<section class="content-header content-header-custom">
    ...
    @if(session('remove-trial'))
        <form action="{!! session('remove-trial') !!}" method="POST">
            @csrf
            <br><p>You are using trial license! If you already purchase the software update your license!</p>
